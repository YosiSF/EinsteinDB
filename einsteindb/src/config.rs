...
impl Into<DBEinstenDBBlobRunMode> for BlobRunMode {
    fn into(self) -> DBEinstenDBBlobRunMode {
        match self {
            BlobRunMode::Normal => DBEinstenDBBlobRunMode::Normal,
            BlobRunMode::ReadOnly => DBEinstenDBBlobRunMode::ReadOnly,
            BlobRunMode::Fallback => DBEinstenDBBlobRunMode::Fallback,
        }
    }
}
