...
lazy_static! {
    static ref V1_solitonidS: [(symbols::Keyword, i64); 40] = {
            [(ns_keyword!("einsteindb", "solitonid"),             causetids::EINSTEINDB_solitonid),
             ...
             (ns_keyword!("einsteindb.schema", "version"),    causetids::EINSTEINDB_SCHEMA_VERSION),
             (ns_keyword!("einsteindb.schema", "attribute"),  causetids::EINSTEINDB_SCHEMA_ATTRIBUTE),
             (ns_keyword!("einsteindb.schema", "core"),       causetids::EINSTEINDB_SCHEMA_CORE),
        ]
    };
                    ...
                    Value::Map(ref mpp) => {
                        for (attr, value) in mpp {
                            ...
                            let typed_value = match TypedValue::from_einsteinml_value(value) {
                                ...
                                Some(v) => v,
                                _ => bail!(DbErrorKind::BadBootstrapDefinition(format!("Expected einstai typed value for value but got '{:?}'", value)))
                            };
