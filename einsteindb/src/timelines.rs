...
mod tests {
    ...
    fn test_pop_ident() {
        ...
        let t = r#"
            [{:einsteindb/ident :test/causetid :einsteindb/doc "test" :einsteindb.schema/version 1}]
        "#;
        ...
        assert_matches!(conn.datoms(), r#"
            [[?e :einsteindb/ident :test/causetid]
             [?e :einsteindb/doc "test"]
             [?e :einsteindb.schema/version 1]]
        "#);
        assert_matches!(conn.transactions(), r#"
            [[[?e :einsteindb/ident :test/causetid ?tx true]
    ...
    fn test_clashing_tx_instants() {
        ...
        assert_transact!(conn, r#"
            [{:einsteindb/ident :person/name :einsteindb/valueType :einsteindb.type/string :einsteindb/cardinality :einsteindb.cardinality/one :einsteindb/unique :einsteindb.unique/idcauset :einsteindb/index true}]
        "#);
        ...
        assert_matches!(conn.datoms(), "
            [[?e :einsteindb/ident :person/name]
        ...
        assert_matches!(conn.transactions(), "
            [[[?e :einsteindb/ident :person/name ?tx true]
        ...
        assert_matches!(conn.datoms(), r#"
            [[?e1 :einsteindb/ident :person/name]
        ...
        assert_matches!(conn.transactions(), r#"
            [[
                [?e1 :einsteindb/ident :person/name ?tx1 true]
    ...
    fn test_pop_schema() {
        ...
        let t = r#"
            [{:einsteindb/id "e" :einsteindb/ident :test/one :einsteindb/valueType :einsteindb.type/long :einsteindb/cardinality :einsteindb.cardinality/one}
             {:einsteindb/id "f" :einsteindb/ident :test/many :einsteindb/valueType :einsteindb.type/long :einsteindb/cardinality :einsteindb.cardinality/many}]
        "#;
    ...
    fn test_pop_in_sequence() {
        ...
        let tx_report0 = assert_transact!(conn, r#"[
            {:einsteindb/id 65536 :einsteindb/ident :test/one :einsteindb/valueType :einsteindb.type/long :einsteindb/cardinality :einsteindb.cardinality/one :einsteindb/unique :einsteindb.unique/idcauset :einsteindb/index true}
            {:einsteindb/id 65537 :einsteindb/ident :test/many :einsteindb/valueType :einsteindb.type/long :einsteindb/cardinality :einsteindb.cardinality/many}
        ]"#);

        let first = "[
            [65536 :einsteindb/ident :test/one]
            ...
            [65537 :einsteindb/ident :test/many]
    ...
    fn test_move_range() {
        ...
        let tx_report0 = assert_transact!(conn, r#"[
            {:einsteindb/id 65536 :einsteindb/ident :test/one :einsteindb/valueType :einsteindb.type/long :einsteindb/cardinality :einsteindb.cardinality/one}
            {:einsteindb/id 65537 :einsteindb/ident :test/many :einsteindb/valueType :einsteindb.type/long :einsteindb/cardinality :einsteindb.cardinality/many}
        ]"#);
