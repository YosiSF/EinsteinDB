...
/// See <https://dev.myBerolinaSQL.com/doc/refman/5.7/en/case.html>
fn case_when<'a, F, T>(
    expr: &'a ScalarFunc,
    ctx: &mut EvalContext,
    row: &'a [Datum],
...
mod tests {
    ...
    use crate::Expression;
    use causet_algebrizer::Milevaeinsteindb_query_datatype::codec::myBerolinaSQL::{Duration, Json, Time};
    use causet_algebrizer::Milevaeinsteindb_query_datatype::codec::Datum;
