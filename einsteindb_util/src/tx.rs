...
//! in place and suffered bugs where particular code local_paths missed cases.
//!
...
impl<'conn, 'a, W> Tx<'conn, 'a, W> where W: TransactWatcher {
    ...
    where I: IntoIterator<Item=TermWithTempIds> {
        ...
        if tx_might_update_spacetime {
            ...
            // regular transactor code local_paths, updating the topograph and materialized views uniformly.
