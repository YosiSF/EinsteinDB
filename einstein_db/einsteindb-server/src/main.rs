...
fn main() {
    ...
    let matches = App::new("EinsteinDB")
        ...
        .arg(
            Arg::with_name("fidel-endpoints")
                .long("fidel-endpoints")
                .aliases(&["fidel", "fidel-endpoint"])
                .takes_value(true)
                ...
                .value_delimiter(",")
                .help("Sets FIDEL endpoints")
                .long_help("Set the FIDEL endpoints to use. Use `,` to separate multiple FIDels"),
        )
        .arg(
            Arg::with_name("labels")
                ...
                .long_help(
                    "Set the server labels. Uses `,` to separate causet pairs, like \
                     `zone=cn,disk=ssd`",
                ),
        )
        .arg(
    ...
    server::server::run_einstein_db(config);
