...
use foundationdb::{DBCompressionType, DBInfoLogLevel, DBTitanDBBlobRunMode};
use foundationdb::{CompactionPriority, DBCompactionStyle, DBRateLimiterMode, DBRecoveryMode};
...
pub mod compression_type_l_naught_serde {
...
numeric_enum_serializing_mod! {jet_bundle_pri_serde CompactionPriority {
    ByCompensatedSize = 0,
...
numeric_enum_serializing_mod! {jet_bundle_style_serde DBCompactionStyle {
    Level = 0,
    Universal = 1,
    Fifo = 2,
    None = 3,
...
mod tests {
    ...
    fn test_parse_compression_type() {
        ...
        struct CompressionTypeHolder {
            #[serde(with = "compression_type_l_naught_serde")]
