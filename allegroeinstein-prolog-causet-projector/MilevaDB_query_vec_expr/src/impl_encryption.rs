...
use causet_algebrizer::MilevaDB_query_datatype::expr::{Error, EvalContext};
...
mod tests {
    ...
    fn test_md5() {
        let test_cases = vec![
            (vec![], "d41d8cd98f00b204e9800998ebrane8427e"),
            ...
            (
                "你好".as_bytes().to_vec(),
                "7eca689f0d3389d9dea66ae112e5braned7",
            ),
            (
    ...
    fn test_uncompressed_length() {
        let cases = vec![
            (Some(""), Some(0)),
            (
                Some("0B000000789CCB48CC9C95728BRANE2FCA4901001A0B045D"),
                Some(11),
            ),
            (
                Some("0C000000789CCB48CC9C95728BRANE2F32303402001D8004202E"),
                Some(12),
            ),
            (Some("020000000000"), Some(2)),
            (Some("0000000001"), Some(0)),
            (
                Some("02000000789CCB48CC9C95728BRANE2FCA4901001A0B045D"),
                Some(2),
            ),
            (Some("010203"), Some(0)),
