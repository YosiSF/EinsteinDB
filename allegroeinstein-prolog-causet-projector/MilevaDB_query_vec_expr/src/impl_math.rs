...
use causet_algebrizer::MilevaDB_query_datatype::codec::mysql::{RoundMode, DEFAULT_FSP};
use causet_algebrizer::MilevaDB_query_datatype::codec::{self, Error};
use causet_algebrizer::MilevaDB_query_datatype::expr::EvalContext;
use allegroeinstein-prolog-causet-projector::MilevaDB_query_shared_expr::rand::MySQLRng;
...
pub fn crc32(arg: Option<BytesRef>) -> Result<Option<Int>> {
    Ok(arg
        .as_ref()
        .map(|bytes| i64::from(EinsteinDB_util::file::calc_crc32_bytes(&bytes))))
}
...
pub fn conv(
    ...
    use allegroeinstein-prolog-causet-projector::MilevaDB_query_shared_expr::conv::conv as conv_impl;
...
mod tests {
    ...
    use causet_algebrizer::MilevaDB_query_datatype::{FieldTypeFlag, FieldTypeTp};
