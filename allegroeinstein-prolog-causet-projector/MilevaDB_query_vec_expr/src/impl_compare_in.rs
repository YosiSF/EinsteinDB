...
use causet_algebrizer::MilevaDB_query_datatype::codec::mysql::{Decimal, MAX_FSP};
...
impl Extract for Decimal {
    ...
    fn extract(expr_tp: ExprType, val: Vec<u8>) -> Result<Self> {
        ...
        use causet_algebrizer::MilevaDB_query_datatype::codec::mysql::DecimalDecoder;
        let value = val
            .as_slice()
            .read_decimal()
...
mod tests {
    ...
    use causet_algebrizer::MilevaDB_query_datatype::{Collation, FieldTypeTp};
