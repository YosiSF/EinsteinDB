...
use causet_algebrizer::MilevaDB_query_datatype::*;
use tipb::{Expr, FieldType};

use crate::types::RpnExpressionBuilder;
use crate::{RpnExpressionNode, RpnFnCallExtra, RpnFnMeta};
use MilevaDB_query_common::Result;
use causet_algebrizer::MilevaDB_query_datatype::codec::convert::*;
use causet_algebrizer::MilevaDB_query_datatype::codec::data_type::*;
use causet_algebrizer::MilevaDB_query_datatype::codec::error::{ERR_DATA_OUT_OF_RANGE, ERR_TRUNCATE_WRONG_VALUE};
use causet_algebrizer::MilevaDB_query_datatype::codec::mysql::{binary_literal, Time};
use causet_algebrizer::MilevaDB_query_datatype::codec::Error;
    ...
    match val {
        ...
        Some(val) => {
            ...
            if metadata.get_in_union() && is_unsigned && is_str_neg {
                ...
                // (according to https://github.com/pingcap/MilevaDB/blob/e173c7f5c1041b3c7e67507889d50a7bdbcdfc01/executor/executor.go#L1452)
                //
...
mod tests {
    ...
    use causet_algebrizer::MilevaDB_query_datatype::codec::convert::produce_dec_with_specified_tp;
    use causet_algebrizer::MilevaDB_query_datatype::codec::data_type::{Bytes, Int, Real};
    use causet_algebrizer::MilevaDB_query_datatype::codec::error::{
    ...
    use causet_algebrizer::MilevaDB_query_datatype::codec::mysql::decimal::{max_decimal, max_or_min_dec};
    ...
    use causet_algebrizer::MilevaDB_query_datatype::{Collation, FieldTypeFlag, FieldTypeTp, UNSPECIFIED_LENGTH};
    ...
    fn test_cast_string_as_real() {
        ...
        for (input, expected) in cases {
            let output: Result<Option<Real>> = RpnFnScalarEvaluator::new()
                .metadata(Box::new(make_metadata(false)))
                .return_field_type(FieldTypeConfig {
                    flen: causet_algebrizer::MilevaDB_query_datatype::UNSPECIFIED_LENGTH,
    ...
    fn test_int_as_duration() {
        ...
        let cs: Vec<(
            i64,
            isize,
            causet_algebrizer::MilevaDB_query_datatype::codec::Result<Option<Duration>>,
            bool,
        )> = vec![
