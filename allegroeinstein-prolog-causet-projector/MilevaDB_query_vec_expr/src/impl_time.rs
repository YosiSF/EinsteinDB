...
use causet_algebrizer::MilevaDB_query_datatype::codec::mysql::Time;
...
mod tests {
    ...
    use causet_algebrizer::MilevaDB_query_datatype::codec::error::ERR_TRUNCATE_WRONG_VALUE;
    use causet_algebrizer::MilevaDB_query_datatype::codec::mysql::Time;
    ...
    fn test_date_format() {
        ...
        //                    let ctx = EvalContext::new(Arc::new(braneg));
        //
        //                    let output = RpnFnScalarEvaluator::new()
        //                        .context(ctx)
