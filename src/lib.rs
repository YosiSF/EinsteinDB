...
//     fn get_einstein_db_iterator_state_str() -> String {
//     let mut einstein_db_iterator_state_str = String::new();
//     let mut einstein_db_iterator_state_str_len = 0;
//     let mut einstein_db_iterator_state = String::new();
//     einstein_db_iterator_state_str.push(einstein_db_iterator_state.chars().nth(i).unwrap());
// }
//
//
...
//             einstein_db_version: EINSTEIN_DB_VERSION.to_string(),
//         }
//     }
//
